...
<div class="app app-default">
  <aside class="app-sidebar" id="sidebar">
    <div class="sidebar-header"> <a class="sidebar-brand" href="home.php"><img src="images/<?php echo APP_LOGO;?>" alt="app logo" /></a>
      <button type="button" class="sidebar-toggle" style="font-size: 30px"> &times; </button>
    </div>
    <div class="sidebar-menu">
      <ul class="sidebar-nav">
        ...
        <li <?php if($currentFile=="manage_genres.php" or $currentFile=="add_genre.php"){?>class="active"<?php }?>> <a href="manage_genres.php">
          <div class="icon"> <i class="fa fa-list" aria-hidden="true"></i> </div>
          <div class="title">Genre</div>
          </a> 
        </li>
        
        <li <?php if($currentFile=="manage_reviews.php" or $currentFile=="add_review.php" or $currentFile=="edit_review.php"){?>class="active"<?php }?>> <a href="manage_reviews.php">
