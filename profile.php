              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 col-md-offset-1 control-label">Profile Image :-</label>
                    <div class="col-md-6">
                      ...
                      <?php if($row['image']!="") {?>
                        <img src="images/<?php echo $row['image'];?>" alt="category image" style="width: 30%;border-radius: 50%"/>
                      <?php } ?>
                    </div>
                  </div>
                  <br/>
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-6">
                          <?php if($row['image']!="") {?>
                            <div class="block_wallpaper"><img src="images/<?php echo $row['image'];?>" alt="category image" /></div>
                          <?php } ?>
                    </div>
                  </div><br> -->
                  <div class="form-group">
